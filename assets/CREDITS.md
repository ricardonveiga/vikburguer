# Créditos de mídia (placeholders)

As fotos do cardápio e o vídeo do Hero usados neste projeto são **imagens/vídeos temporários** de
bancos livres (Wikimedia Commons), sob licenças Creative Commons / domínio público, usados apenas
para deixar o site completo e navegável enquanto fotos profissionais reais da Vik Burguer não
são produzidas. **Recomendação forte: substituir todos os arquivos em `assets/menu/` e
`assets/video/` por fotos e vídeo autorais do próprio estabelecimento assim que possível** —
isso é o que vai realmente vender o produto e evitar qualquer questão de licenciamento/atribuição
a longo prazo.

Cada imagem abaixo pode exigir atribuição ao autor conforme a licença da página de origem.
Consulte o link de cada uma antes de qualquer uso comercial contínuo.
...
| vik-onion.jpg | https://commons.wikimedia.org/wiki/File:Bleu_ribbon_veggie_burger_cc_flickr_user_freakapotimus.jpg |
...
| batata-simples.jpg | https://commons.wikimedia.org/wiki/File:Cone_full_o%27_fries_with_mayo,_Amsterdam_style_(2164277255).jpg |
| batata-rustica.jpg | https://commons.wikimedia.org/wiki/File:Crispy_golden_potato_wedges_on_a_baking_tray_ready_for_serving_at_home.jpg |
...
| about-bg-buns.jpg | https://commons.wikimedia.org/wiki/File:HK_TST_Star_House_McDonalds_Big_Mac_hamburger_sesame_seed_bun.jpg |
| combo-junior.jpg | https://commons.wikimedia.org/wiki/File:Burger_and_fries_on_a_wooden_plate.jpg |
| combo-duplo.jpg | https://commons.wikimedia.org/wiki/File:DFC_2284_A_juicy_sesame-topped_burger_stacked_with_fresh_curly_lettuce_and_creamy_sauce_served_with_crispy_fries_and_dipping_sauces_on_a_wooden_board.jpg |
| combo-classico.jpg | https://commons.wikimedia.org/wiki/File:DFC_1097_A_juicy_cheeseburger_with_lettuce_on_a_sesame_seed_bun_served_on_a_wooden_board_with_a_side_of_fries_and_a_cold_drink.jpg |
| combo-familia.jpg | https://commons.wikimedia.org/wiki/File:%D0%9C%D0%B8%D0%BD%D0%B8_%D0%B1%D1%83%D1%80%D0%B3%D0%B5%D1%80%D0%B8,_%D0%BD%D0%B0_%D1%82%D1%80%D0%BA%D0%B0%D0%BB%D0%B5%D0%B7%D0%BD%D0%B0_%D0%BC%D0%B0%D1%81%D0%B0.jpg |
| video/hero-burger-1080.webm, hero-burger-480.webm, hero-poster*.jpg | https://commons.wikimedia.org/wiki/File:Hamburger-fries-tokyo-japan-july31-2021.webm |

O logo (`assets/logo.jfif` / `assets/logo.png`) foi fornecido pelo cliente; `logo.png` é a
mesma logo com o fundo preto removido (transparência), gerada localmente para permitir
sobrepor a marca em qualquer seção do site.
